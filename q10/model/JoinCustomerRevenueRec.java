...
public class JoinCustomerRevenueRec implements Serializable {
    ...
    public JoinCustomerRevenueRec(){}

    public JoinCustomerRevenueRec(boolean insert, int nationKey, int custKey, int orderKey,
                                  String custName, double acctBal, String address, String phone,
                                  String comment, double revenue){
        this.insert   = insert;
